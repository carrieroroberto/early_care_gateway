// Import routing utilities for navigation and nested routes
import { Outlet, useNavigate, useLocation } from "react-router-dom";

// Import icons used in the layout from lucide-react
...
const Layout = () => {
  ...
  // Hook used to get the current route location
  const location = useLocation();

  // Handles user logout by clearing stored data and redirecting to login page
  const handleLogout = () => {
  ...
  // Retrieve stored doctor information from local storage
  ...
  const displayName = userInfo
    ? `Dr. ${userInfo.name} ${userInfo.surname}`
    : "Dr. User";
